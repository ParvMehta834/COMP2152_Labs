...
# Lab04 Q5
print("You find a loop bag! Look inside to find 2 items.")
...
print("You got the loots, so organize your belt alphabericallty:")
belt.sort()
print("Your belt: ", belt)
...
if first_item in good_loot_options:
    ...
    print("You used  {first_item}, to hurt your health changed to {health_points}")
else:
    print("You used {first_item}, but it was not helpful")   
...
#Lab 04 Question 3
# Roll for the Monster Combat Strength by it's Power
combat_strength = min(6, m_combat_strength + monster_power[power_roll])
print("YThe Monster Combat Strength is no " + str(combat_strength) + "Using the " + power_roll + " magic power.")
